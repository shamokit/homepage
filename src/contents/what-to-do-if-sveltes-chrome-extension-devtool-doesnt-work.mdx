...
___
## 起こったこと
chrome拡張の(Svelte Devtools)[https://chrome.google.com/webstore/detail/svelte-devtools/ckolcbmkjpjmangdbmnkpjigpkddpogn]が上記の環境で動きませんでした。
...
(chrome://extensions/)[chrome://extensions/]にアクセスすると「Svelte Devtools」があると思うので削除します。
...
## Chrome拡張として読み込ませる
(chrome://extensions/)[chrome://extensions/]に戻ります。
